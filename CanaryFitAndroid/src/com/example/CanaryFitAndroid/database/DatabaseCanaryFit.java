...
/**
 * Clase que contiene métodos para configurar la base de datos (abrir/cerrar la bd, guardar elementos, ...)
 */
public class DatabaseCanaryFit extends AndroidScreenDatabase
